...
class ClassSizeCatalogImpl extends ClassSizeCatalog
{
    ClassSizeCatalogImpl()
    {
        ...
        put( "org.apache.derby.iapi.types.SQLTimestamp", new int[]{12,2});
        ...
        put( "org.apache.derby.impl.store.access.btree.index.B2I", new int[]{40,6});
        put( "org.apache.derby.impl.store.access.btree.BTree", new int[]{28,6});
        ...
        put( "org.apache.derby.iapi.types.SQLTime", new int[]{8,2});
        ...
        put( "org.apache.derby.iapi.types.SQLDate", new int[]{4,2});
        ...
        put( "org.apache.derby.impl.store.access.heap.Heap", new int[]{8,5});
        put( "java.math.BigDecimal", new int[]{16,4});
        put( "org.apache.derby.impl.store.access.btree.index.B2I_v10_2", new int[]{40,6});
        ...
        put( "org.apache.derby.impl.store.access.btree.index.B2I_10_3", new int[]{40,6});
        put( "org.apache.derby.impl.services.cache.CachedItem", new int[]{24,3});
        put( "org.apache.derby.impl.store.access.heap.Heap_v10_2", new int[]{8,5});
